      ...
      items: [
        {
          question: "What does your company specialize in?",
          answer:
            "We provide end-to-end automation solutions including robotic systems, automated assembly lines, vision inspection systems, and functional testing solutions tailored to manufacturing environments.",
        },
        {
          question: "Which industries do you serve?",
          answer:
            "We serve automotive, EV, electronics, medical devices, and industrial manufacturing sectors.",
        },
        {
          question: "Do you provide turnkey automation solutions?",
          answer:
            "Yes. We handle the complete lifecycle from concept design and simulation to manufacturing, installation, commissioning, and after-sales support.",
        },
        {
          question: "Can you customize solutions based on our production needs?",
          answer:
            "Absolutely. All our solutions are custom-designed to match your product, process, cycle time, quality, and factory layout requirements.",
        },
      ],
    },
    {
      ...
      items: [
        {
          question: "What types of automation solutions do you offer?",
          answer:
            "We offer robotic assembly, Robotic screw fixing, dispensing, Vision Inspection, palletizing, material handling, and special-purpose machines (SPMs).",
        },
        {
          question: "Do you work with collaborative robots (cobots)?",
          answer:
            "Yes. We integrate both industrial robots and collaborative robots depending on safety, space, and application requirements.",
        },
        {
          question: "Can your systems integrate with existing machines?",
          answer:
            "Yes. Our solutions are designed to seamlessly integrate with legacy machines, PLCs, MES, and ERP systems.",
        },
        {
          question: "How do you ensure operator safety in robotic cells?",
          answer:
            "We implement safety fencing, light curtains, scanners, interlocks, and safety PLCs compliant with safety standards.",
        },
      ],
    },
    {
      ...
      items: [
        {
          question: "What inspection solutions do you provide?",
          answer:
            "We offer camera-based vision inspection systems for presence checks, dimensional measurement, OCR/OCV, 3D Optical Inspection and defect detection.",
        },
        {
          question: "Can your inspection systems detect assembly errors?",
          answer:
            "Yes. Our systems verify correct part assembly, orientation, colour, connectors, labels, and fasteners in real time.",
        },
        {
          question: "Do you use AI-based inspection?",
          answer:
            "Yes. We use AI and deep-learning-based vision systems for complex defect detection and pattern recognition where traditional vision is limited.",
        },
        {
          question: "How accurate are your vision inspection systems?",
          answer:
            "Our systems are designed for high accuracy and repeatability, often achieving inspection reliability above 99% depending on application conditions.",
        },
      ],
    },
    {
      ...
      items: [
        {
          question:
            "Do you provide manual, semi-automatic, and fully automatic assembly lines?",
          answer:
            "Yes. We design manual workstations, semi-automatic lines, and fully automated assembly systems based on volume and flexibility needs.",
        },
        {
          question: "Can you automate screw driving and fastening operations?",
          answer:
            "Yes. We provide robotic screw driving systems with automatic screw feeders and torque monitoring.",
        },
        {
          question: "How do you ensure assembly quality?",
          answer:
            "We implement poka-yoke mechanisms, vision verification, torque/force monitoring, and traceability at every critical station.",
        },
      ],
    },
    {
      ...
      items: [
        {
          question: "What types of testing systems do you offer?",
          answer:
            "We offer functional testing, electrical testing, leak testing, Vibration Testing, end-of-line (EOL) testing, and durability testing systems.",
        },
        {
          question: "Can your test systems store and analyse test data?",
          answer:
            "Yes. All test data can be logged, analysed, and linked to serial numbers for complete product traceability.",
        },
        {
          question:
            "Do you support industry standards and compliance testing?",
          answer:
            "Yes. Our systems are designed to comply with relevant industry standards and customer-specific quality requirements.",
        },
      ],
    },
    {
      ...
      items: [
        {
          question: "Do you offer traceability solutions?",
          answer:
            "Yes. We provide end-to-end traceability using barcodes, RFID, and vision-based identification across assembly and test lines.",
        },
        {
          question: "Can your systems provide real-time production data?",
          answer:
            "Yes. Our solutions support real-time dashboards, OEE monitoring, alarms, and production analytics.",
        },
        {
          question:
            "Do you support Industry 4.0 and smart factory concepts?",
          answer:
            "Yes. Our systems are Industry 4.0 ready with connectivity for MES, cloud platforms, AI analytics, and digital twins.",
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          answer:
            "Yes. Our engineers handle on-site installation, commissioning, and operator training.",
        },
        {
          question: "What kind of after-sales support do you offer?",
          answer:
            "We offer AMC, remote support, on-site service, and spare parts support to ensure maximum uptime.",
        },
        {
          question:
            "Do you provide training for operators and maintenance teams?",
          answer:
            "Yes. We provide comprehensive training for operators, maintenance staff, and quality teams.",
        },
      ],
    },
    {
      ...
      items: [
        {
          question:
            "How long does it take to deliver an automation project?",
          answer:
            "Project timelines vary based on complexity, but we typically deliver within 8–16 weeks.",
        },
      ],
    },
  ];
    ...
    <main className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-slate-100">
      ...
      <header className="relative overflow-hidden bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-24">
          <div className="text-center">
            <div
              className={`inline-flex items-center justify-center p-3 bg-white/10 backdrop-blur-sm rounded-2xl mb-6 transform transition-all duration-700 ${
                mounted
            ...
            <h1
              className={`text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold text-white mb-4 sm:mb-6 transform transition-all duration-700 delay-100 ${
                mounted
                  ? "translate-y-0 opacity-100"
                  : "translate-y-4 opacity-0"
              }`}
            ...
            <p
              className={`text-base sm:text-lg md:text-xl text-blue-100 max-w-3xl mx-auto leading-relaxed px-4 transform transition-all duration-700 delay-200 ${
                mounted
                  ? "translate-y-0 opacity-100"
                  : "translate-y-4 opacity-0"
              }`}
            >
              ...
              services, and expertise in manufacturing technology
            </p>

            {/* Stats */}
            <div
              className={`mt-8 sm:mt-12 grid grid-cols-3 gap-4 md:gap-8 max-w-3xl mx-auto transform transition-all duration-700 delay-300 ${
                mounted
                  ? "translate-y-0 opacity-100"
                  : "translate-y-4 opacity-0"
              }`}
            ...
            >
              ...
              <div
                className="text-center border-x border-blue-400/30"
                aria-hidden="true"
              >
                <p className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-1 sm:mb-2">
                  {faqData.length}
        ...
        <div className="absolute bottom-0 left-0 right-0" aria-hidden="true">
          <svg
            ...
            className="w-full h-10 sm:h-12 md:h-16"
          >
            <path
      ...
      {/* Main Content */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 sm:pt-8 pb-12 sm:pb-16 relative z-10">
        {/* Search and Filter Section */}
        <section
          aria-label="Search and filter questions"
          className="bg-white rounded-xl sm:rounded-2xl shadow-xl border border-blue-100 p-4 md:p-6 mb-6 sm:mb-8"
        >
          <div className="flex flex-col lg:flex-row gap-4">
            {/* Search Bar */}
            <div className="flex-1" role="search">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  value={searchTerm}
                  onChange={(e) => setSearchTerm(e.target.value)}
                  className="w-full pl-12 pr-4 py-3 sm:py-3.5 rounded-xl border-2 border-gray-200 focus:outline-none focus:border-blue-500 focus:ring-4 focus:ring-blue-100 transition-all text-gray-700 placeholder-gray-400"
                />
                {searchTerm && (
                  <button
                    onClick={() => setSearchTerm("")}
            ...
            <button
              ...
              className="lg:hidden flex items-center justify-center gap-2 px-6 py-3 sm:py-3.5 bg-blue-600 text-white rounded-xl font-medium hover:bg-blue-700 transition-all"
            >
              <Filter className="w-5 h-5" aria-hidden="true" />
              Filters
              {activeCategory !== "all" && (
                <span
                  className="bg-white text-blue-600 px-2 py-0.5 rounded-full text-xs font-bold"
          ...
          {showMobileFilters && (
            <div
              id="mobile-filters"
              className="lg:hidden mt-4 p-4 bg-gray-50 rounded-xl"
              role="tablist"
              aria-label="FAQ categories"
            >
              <div className="flex items-center justify-between mb-4">
        ...
        >
          {filteredFAQs.map((category, catIndex) => {
            ...
            return (
              <section
                key={catIndex}
                aria-labelledby={`category-heading-${catIndex}`}
                className="group"
                style={{
                  animation: `fadeInUp 0.5s ease-out ${catIndex * 0.1}s both`,
                }}
              >
                {/* Category Card */}
                <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg border border-blue-100 overflow-hidden hover:shadow-xl transition-all duration-300">
                  {/* Category Header */}
                  <div
                    className={`relative bg-gradient-to-r ${category.gradient} p-4 sm:p-6 overflow-hidden`}
                  >
                    <div
                    ...
                    <div className="relative flex items-center justify-between">
                      <div className="flex items-center gap-3 sm:gap-4">
                        <div
                          className="p-2.5 sm:p-3 bg-white/20 backdrop-blur-sm rounded-xl"
                          aria-hidden="true"
                        >
                  ...
                  <div className="divide-y divide-gray-100">
                    {category.items.map((item, itemIndex) => {
                      ...
                      const currentIndex = globalIndex;
                      const isOpen = openIndex === currentIndex;
                      const questionId = `faq-question-${currentIndex}`;
                      const answerId = `faq-answer-${currentIndex}`;
                      ...
                      return (
                        ...
                        >
                          <button
                            ...
                            className="w-full px-4 sm:px-6 py-4 sm:py-5 md:py-6 text-left focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-inset group/item cursor-pointer"
                          >
                            <div className="flex items-start gap-3 sm:gap-4">
                              {/* Question Number */}
                              <div
                                className={`flex-shrink-0 w-7 h-7 sm:w-8 sm:h-8 rounded-lg flex items-center justify-center font-bold text-xs sm:text-sm transition-all duration-300 ${
                                  isOpen
                                    ? "bg-gradient-to-br from-blue-600 to-indigo-600 text-white shadow-lg"
                                    : "bg-blue-100 text-blue-600 group-hover/item:bg-blue-200"
                                }`}
                              ...
                              {/* Chevron Icon */}
                              <div
                                className={`flex-shrink-0 w-8 h-8 sm:w-10 sm:h-10 rounded-lg flex items-center justify-center transition-all duration-300 ${
                                  isOpen
                                    ? "bg-blue-100 rotate-180"
                                    : "bg-gray-100 group-hover/item:bg-blue-100"
                                }`}
                          ...
                          <div
                            ...
                            hidden={!isOpen}
                          >
                            <div className="px-4 sm:px-6 pb-4 sm:pb-6 md:pl-[4.5rem]">
                              <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-4 sm:p-5 md:p-6 border-l-4 border-blue-600">
        ...
        {filteredFAQs.length === 0 && (
          <div
            className="bg-white rounded-xl sm:rounded-2xl shadow-lg border border-blue-100 p-8 sm:p-12 text-center"
            role="status"
            aria-live="polite"
          >
            <div
            ...
            <p className="text-gray-600 mb-6 max-w-md mx-auto text-sm sm:text-base">
              We couldn&apos;t find any questions matching &ldquo;{searchTerm}
              &rdquo;. Try adjusting your search or browse all categories.
            </p>
            <button
              onClick={() => {
                setSearchTerm("");
        ...
        <section
          ...
          className="mt-8 sm:mt-12 grid md:grid-cols-2 gap-4 sm:gap-6"
        >
          {/* Main CTA */}
          <div className="relative overflow-hidden bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 rounded-xl sm:rounded-2xl shadow-2xl p-6 sm:p-8 md:p-10">
            <div className="absolute inset-0 opacity-10" aria-hidden="true">
              <div
                className="absolute inset-0"
                style={{
            ...
            <div className="relative">
              <div
                className="inline-flex p-2.5 sm:p-3 bg-white/10 backdrop-blur-sm rounded-xl mb-4"
                aria-hidden="true"
              >
              ...
              <p className="text-blue-100 mb-6 leading-relaxed text-sm sm:text-base">
                Our automation experts are ready to discuss your specific
                manufacturing needs and provide tailored solutions.
              </p>
              <Link
                href="/contact"
                className="inline-flex items-center gap-2 bg-white text-blue-600 px-6 sm:px-8 py-3 sm:py-4 rounded-xl font-semibold hover:bg-blue-50 transition-all shadow-xl hover:shadow-2xl transform hover:-translate-y-1 group"
              >
                Contact Our Team
                <ArrowRight
          ...
          <div className="grid grid-cols-1 gap-4">
            <a
              ...
              className="bg-white rounded-xl sm:rounded-2xl shadow-lg border border-blue-100 p-4 sm:p-6 hover:shadow-xl transition-all group block"
              aria-label="Email us at info@micrologicglobal.com"
            >
              <div className="flex items-start gap-3 sm:gap-4">
                <div
                  className="p-2.5 sm:p-3 bg-blue-100 rounded-xl group-hover:bg-blue-600 transition-colors"
                  aria-hidden="true"
                >
            ...
            <a
              ...
              className="bg-white rounded-xl sm:rounded-2xl shadow-lg border border-blue-100 p-4 sm:p-6 hover:shadow-xl transition-all group block"
              aria-label="Call us at +91 9663 521132"
            >
              <div className="flex items-start gap-3 sm:gap-4">
                <div
                  className="p-2.5 sm:p-3 bg-blue-100 rounded-xl group-hover:bg-blue-600 transition-colors"
                  aria-hidden="true"
                >
                  <Phone className="w-5 h-5 sm:w-6 sm:h-6 text-blue-600 group-hover:text-white transition-colors" />
                </div>
                <div className="flex-1">
                  <h4 className="font-semibold text-gray-900 mb-1 text-sm sm:text-base">
                    Phone Support
