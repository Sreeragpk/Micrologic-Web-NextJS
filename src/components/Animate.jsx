    ...
    <section className="relative flex flex-col min-h-screen lg:min-h-[700px] xl:min-h-[800px] overflow-hidden bg-gradient-to-br from-gray-50 via-white to-blue-50 py-8 sm:py-10 md:py-12 lg:py-8 xl:py-10 px-4 sm:px-6 lg:px-8 xl:px-12">
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between flex-1 z-10">
        ...
        <div className="w-full lg:w-1/2 px-4 sm:px-6 lg:pr-8 xl:pr-12 2xl:pr-16">
          <motion.div 
            initial={{ opacity: 0, x: windowWidth >= 1024 ? -50 : 0, y: windowWidth < 1024 ? 20 : 0 }}
            animate={{ opacity: 1, x: 0, y: 0 }}
            transition={{ duration: 0.8, delay: 0.2 }}
            className="space-y-4 sm:space-y-6 md:space-y-8"
          >
            <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 leading-relaxed">
              Explore our advanced automation, testing, and manufacturing solutions engineered to deliver efficiency, precision, and reliability. From concept to deployment, we design intelligent systems that empower modern factories with scalable, future-ready production technologies.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 md:gap-5 lg:gap-6 mt-4 sm:mt-6 md:mt-8">
              <div className="bg-white/70 backdrop-blur-sm p-3 sm:p-4 md:p-5 lg:p-6 rounded-xl md:rounded-2xl shadow-lg border border-gray-100/50 hover:shadow-xl transition-all duration-300">
                <div className="flex items-center mb-2 sm:mb-3 md:mb-4">
                  ...
                  <h3 className="ml-2 sm:ml-3 text-sm sm:text-base md:text-lg font-semibold text-gray-800">Mechanical Engineering</h3>
                </div>
                <p className="text-gray-600 text-xs sm:text-sm md:text-base leading-relaxed">
                  Precision-driven mechanical design, prototyping, and machine development built for durability, accuracy, and high-performance industrial automation systems.
                </p>
              </div>
              ...
              <div className="bg-white/70 backdrop-blur-sm p-3 sm:p-4 md:p-5 lg:p-6 rounded-xl md:rounded-2xl shadow-lg border border-gray-100/50 hover:shadow-xl transition-all duration-300">
                <div className="flex items-center mb-2 sm:mb-3 md:mb-4">
                  ...
                  <h3 className="ml-2 sm:ml-3 text-sm sm:text-base md:text-lg font-semibold text-gray-800">Electrical Engineering</h3>
                </div>
                <p className="text-gray-600 text-xs sm:text-sm md:text-base leading-relaxed">
                  Advanced electrical architecture, control panels, and smart system integration designed to power reliable automation, monitoring, and machine intelligence.
                </p>
              </div>
              ...
              <div className="bg-white/70 backdrop-blur-sm p-3 sm:p-4 md:p-5 lg:p-6 rounded-xl md:rounded-2xl shadow-lg border border-gray-100/50 hover:shadow-xl transition-all duration-300">
                <div className="flex items-center mb-2 sm:mb-3 md:mb-4">
                  ...
                  <h3 className="ml-2 sm:ml-3 text-sm sm:text-base md:text-lg font-semibold text-gray-800">Manufacturing & System Integration</h3>
                </div>
                <p className="text-gray-600 text-xs sm:text-sm md:text-base leading-relaxed">
                  End-to-end manufacturing and integration of hardware, software, and automation technologies to create efficient, scalable, and high-quality production systems.
                </p>
              </div>
              ...
              <div className="bg-white/70 backdrop-blur-sm p-3 sm:p-4 md:p-5 lg:p-6 rounded-xl md:rounded-2xl shadow-lg border border-gray-100/50 hover:shadow-xl transition-all duration-300">
                <div className="flex items-center mb-2 sm:mb-3 md:mb-4">
                  ...
                  <h3 className="ml-2 sm:ml-3 text-sm sm:text-base md:text-lg font-semibold text-gray-800">Custom Engineering</h3>
                </div>
                <p className="text-gray-600 text-xs sm:text-sm md:text-base leading-relaxed">
                  Custom-built solutions designed around your production lines, tooling, quality standards, and automation requirements.
                </p>
              </div>
            </div>
          </motion.div>
        ...
        <div className={getCircleContainerClasses()}>
          ...
          >
            ...
            <div className="absolute inset-0 rounded-full overflow-hidden">
              {[...Array(windowWidth < 640 ? 4 : 6)].map((_, i) => {
                const particleRadius = windowWidth < 380 ? 70 : windowWidth < 640 ? 80 : windowWidth < 768 ? 90 : windowWidth < 1024 ? 100 : 110;
                ...
                return (
                  <motion.div
                    ...
                    animate={{
                      x: [
                        Math.cos((i / (windowWidth < 640 ? 4 : 6)) * 2 * Math.PI) * particleRadius,
                        Math.cos((i / (windowWidth < 640 ? 4 : 6)) * 2 * Math.PI) * particleRadiusExpanded,
                        Math.cos((i / (windowWidth < 640 ? 4 : 6)) * 2 * Math.PI) * particleRadius,
                      ],
                      y: [
                        Math.sin((i / (windowWidth < 640 ? 4 : 6)) * 2 * Math.PI) * particleRadius,
                        Math.sin((i / (windowWidth < 640 ? 4 : 6)) * 2 * Math.PI) * particleRadiusExpanded,
                        Math.sin((i / (windowWidth < 640 ? 4 : 6)) * 2 * Math.PI) * particleRadius,
                      ],
                    }}
                    style={{
          ...
          <div className="absolute bottom-2 sm:bottom-3 md:bottom-4 right-2 sm:right-3 md:right-4 bg-white/60 backdrop-blur-md rounded-lg md:rounded-xl p-1.5 sm:p-2 md:p-3 shadow-xl border border-white/30 flex items-center gap-1 sm:gap-1.5 md:gap-2">
            ...
            >
              {isAutoRotating ? <FaPause className={getControlIconSize()} /> : <FaPlay className={getControlIconSize()} />}
            </button>
      ...
      <div className="absolute w-full h-full pointer-events-none overflow-hidden">
        {[...Array(windowWidth < 640 ? 2 : 3)].map((_, i) => {
          const movementRange = windowWidth < 640 ? 8 : windowWidth < 1024 ? 12 : 15;
