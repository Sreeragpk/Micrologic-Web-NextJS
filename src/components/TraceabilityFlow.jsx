                ...
                {[
                  {
                    ...
                    icon: Database,
                    description: "Tracks and records all parts and material used in the production, including components, consumables and housing. Details such as batch code, supplier code, date code are tracked and recorded for each Product ID.",
                    gradient: "from-blue-600 to-blue-500"
                  },
                  {
                    title: "PROCESS TRACEABILITY",
                    icon: Activity,
                    description: "Tracks and records all process parameters and settings such as voltage, current, torque, test results, defects against each product ID.",
                    gradient: "from-blue-500 to-cyan-500"
                  },
                  {
                    title: "LEGACY SYSTEMS",
                    icon: BarChart3,
                    description: "Micrologic Traceware can be effortlessly adapted to any existing legacy machines to provide you complete visibility and important insights",
