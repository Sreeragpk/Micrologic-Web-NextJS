...
const Automotive = () => {
  ...
  const otherIndustries = [
 {
  ...
  return (
    ...
    {/* ============ OTHER INDUSTRIES — ELEGANT WHITE (AUTOMOTIVE PAGE) ============ */}
<section className="relative bg-white py-28 px-6 lg:px-16 overflow-hidden">
  {/* Subtle Background Elements */}
  <div className="absolute inset-0">
    <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-gradient-to-bl from-red-50 via-orange-50/50 to-transparent rounded-full blur-3xl" />
  ...
  <div className="max-w-7xl mx-auto relative z-10">
    ...
    >
      ...
      <h2 className="text-4xl md:text-5xl font-bold text-slate-900 mb-4">
        ...
        <span className="relative">
          ...
          <svg className="absolute -bottom-2 left-0 w-full" viewBox="0 0 200 8" fill="none">
            <path d="M2 6C50 2 150 2 198 6" stroke="url(#auto-underline)" strokeWidth="3" strokeLinecap="round"/>
            <defs>
              <linearGradient id="auto-underline" x1="0" y1="0" x2="200" y2="0">
      ...
      <p className="text-slate-500 text-lg max-w-2xl mx-auto mt-6">
        Driving manufacturing excellence with precision automation — from assembly lines 
        and quality inspection to end-of-line testing and traceability
      </p>
    </motion.div>
            ...
            >
              ...
              >
                ...
                <div className="absolute top-4 right-4">
                  <div className="w-10 h-10 rounded-xl bg-slate-50 border border-slate-100 flex items-center justify-center group-hover:bg-red-50 group-hover:border-red-100 transition-colors">
