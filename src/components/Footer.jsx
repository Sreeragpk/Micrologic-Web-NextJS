...
import { Linkedin, Mail, Phone, Youtube, Instagram, MapPin, Code } from "lucide-react";
      ...
      <div className="container mx-auto px-6 lg:px-12 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            <h3 className="text-2xl font-bold text-white mb-4 bg-gradient-to-r from-green-400 to-blue-500 bg-clip-text text-transparent">
      ...
      <div className="border-t border-gray-700/50">
        <div className="container mx-auto px-6 lg:px-12 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-500">
            <p>
              © {new Date().getFullYear()} Micrologic Integrated Systems Pvt. Ltd. All rights reserved.
            </p>
            <div className="flex gap-6">
              <a href="/privacy-policy" className="hover:text-green-400 transition-colors">
                Privacy Policy
              </a>
              <a href="/terms-and-conditions" className="hover:text-green-400 transition-colors">
                Terms & Conditions
              </a>
            </div>
          </div>
        ...
        <div className="container mx-auto px-6 lg:px-12 py-4">
          <div className="flex justify-center items-center gap-2 text-xs text-gray-500">
            ...
            {/* <a
              ...
              target="_blank"
              rel="noreferrer"
              className="font-semibold bg-gradient-to-r from-white to-blue-500 bg-clip-text text-transparent hover:from-white hover:to-blue-600 transition-all duration-300"
            >
              FactEyes
            </a> */}
            <a
