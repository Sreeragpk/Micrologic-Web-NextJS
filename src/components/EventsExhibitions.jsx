  ...
  const highlights = [
    {
      ...
      description: "Showcased cutting-edge automation applications in real-time action",
      color: "from-blue-500 to-cyan-500",
    },
    {
      icon: Users,
      title: "Industry Engagement",
      description: "Connected with leaders, innovators, and industry professionals",
      color: "from-purple-500 to-indigo-500",
    },
    {
      icon: Sparkles,
      title: "Technology Exchange",
      description: "Vibrant discussions shaping the future of smart manufacturing",
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
        ...
        <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-12 lg:mb-16">
          ...
          >
            ...
            <span className="text-sm font-bold text-slate-700">EVENT COMPLETED</span>
          </motion.div>

          {/* Main Title */}
          <h1 className="text-4xl sm:text-5xl lg:text-7xl font-black mb-4 lg:mb-6 tracking-tight">
            <span className="block text-slate-900 mb-2">🌟 Productronica 2025</span>
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 text-slate-600 mb-6">
            <div className="flex items-center gap-2 px-4 py-2 bg-white/60 backdrop-blur-sm rounded-full border border-slate-200/50">
              ...
              <span className="text-sm font-semibold">{eventDetails.booth}</span>
            </div>
            <div className="flex items-center gap-2 px-4 py-2 bg-white/60 backdrop-blur-sm rounded-full border border-slate-200/50">
              <MapPin className="w-4 h-4 text-emerald-600" />
              <span className="text-sm font-semibold">Bangalore International Exhibition Centre</span>
            </div>
            <div className="flex items-center gap-2 px-4 py-2 bg-white/60 backdrop-blur-sm rounded-full border border-slate-200/50">
              <Clock className="w-4 h-4 text-purple-600" />
              <span className="text-sm font-semibold">{eventDetails.duration}</span>
            </div>
          </div>

          <p className="text-lg lg:text-xl text-slate-600 max-w-4xl mx-auto leading-relaxed font-medium">
            We're thrilled to have wrapped up an incredible three days at Productronica 2025! From showcasing cutting-edge
            automation solutions to engaging with industry leaders and innovators—this event was a true celebration of
            ...
            <div className="grid lg:grid-cols-5 gap-0">
              ...
              <div className="lg:col-span-2 p-8 lg:p-10 bg-gradient-to-br from-slate-50 to-blue-50/50 flex flex-col justify-center">
                ...
                <p className="text-slate-600 leading-relaxed mb-6 text-base lg:text-lg">
                  Watch our exclusive event coverage featuring live automation demos, product showcases, and engaging
                  interactions with industry professionals at Productronica 2025.
                </p>

                <div className="space-y-3 mb-6">
                  {["Live automation demonstrations", "Product showcases & innovations", "Industry expert interactions", "Behind-the-scenes moments"].map(
                    (item, i) => (
        ...
        >
          <div className="text-center mb-10 lg:mb-12">
            ...
            <h2 className="text-3xl lg:text-4xl xl:text-5xl font-black text-slate-900 mb-4">Memorable Moments</h2>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {highlights.map((highlight, i) => (
              ...
              >
                ...
                <h3 className="text-lg lg:text-xl font-black text-slate-900 mb-3">{highlight.title}</h3>
                <p className="text-sm lg:text-base text-slate-600 leading-relaxed">{highlight.description}</p>
              </motion.div>
            ))}
          </div>
        </motion.section>
        ...
        >
          <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-xl border border-slate-200/50 p-8 lg:p-12">
            <div className="text-center mb-10">
              ...
              <h2 className="text-3xl lg:text-4xl font-black text-slate-900 mb-4">Solutions Showcased</h2>
        ...
        >
          ...
          <h2 className="text-3xl lg:text-5xl font-black mb-6">Thank You for Making It Unforgettable!</h2>

          <p className="text-lg lg:text-xl text-white/90 max-w-3xl mx-auto leading-relaxed mb-8">
            A big thank you to everyone who visited us at <strong>Booth G85</strong> and made this experience
            unforgettable. Your enthusiasm and feedback inspire us to keep pushing boundaries and innovating for the future
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              href="/solutions"
              className="inline-flex items-center justify-center gap-2 px-6 py-4 bg-white/10 backdrop-blur-sm text-white border-2 border-white/30 rounded-xl font-bold hover:bg-white/20 transition-all duration-300"
            >
        ...
        >
          <div className="inline-flex items-center gap-3 px-6 py-4 bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-slate-200/50">
            ...
            <div className="text-left">
              <div className="text-sm font-semibold text-slate-500">Recognized As</div>
              <div className="text-lg font-black text-slate-900">Pioneer in Intelligent Automation Systems</div>
            </div>
          </div>
        </motion.div>
      </div>
